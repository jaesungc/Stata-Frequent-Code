...
twoway (connected p_above_uv_grad age if gender==1) (connected p_above_uv_grad age if gender==0), ///
legend(label(1 Male) label(2 Female)) title(Ratio of University Graduates or Above in 2010) ytitle("Proportion") ///
